...
class Finloans_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        'finloans_social_links',


        // Widget name will appear in UI
        esc_html__( '[ Finloans ] Social Links', 'finloans-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'finloans-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'finloans-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'finloans-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'finloans-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'finloans-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'finloans-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'finloans-companion'); ?></label>
...
} // Class finloans_social_links ends here


// Register and load the widget
function finloans_social_links_widget_load() {
	register_widget( 'Finloans_social_links' );
}
add_action( 'widgets_init', 'finloans_social_links_widget_load' );