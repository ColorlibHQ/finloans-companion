(function ($) {
    ...
    if ($.fn.owlCarousel) {
        $(".finloans-service-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".finloans-workflow-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".finloans-team-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.imagesLoaded) {
        $('.finloans-finloans').imagesLoaded(function () {
            // filter items on button click
            $('.finloans-menu').on('click', 'p', function () {
            ...
            // init Isotope
            var $grid = $('.finloans-finloans').isotope({
    ...
    $('.finloans-menu button.btn').on('click', function () {
        $('.finloans-menu button.btn').removeClass('active');
    ...
    // MC Scripts
    var $subscribe = $('.finloans-subscribe-newsletter-area');
    if ($subscribe.length) {
