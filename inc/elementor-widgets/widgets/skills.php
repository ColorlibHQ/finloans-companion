...
/**
 *
 * Finloans elementor skills section widget.
 *
 * @since 1.0
 */
class Finloans_Skills extends Widget_Base {

	public function get_name() {
		return 'finloans-skills';
	}

	public function get_title() {
		return __( 'My Skills', 'finloans-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'skills_content',
			[
				'label' => __( 'Skills content', 'finloans-companion' ),
			]
        );
        ...
        $this->add_control(
            'sec_title',
            [
                'label' => esc_html__( 'Section Title', 'finloans-companion' ),
                'type' => Controls_Manager::TEXTAREA,
                'label_block' => true,
                'default'   => esc_html__( 'I’m a Creative director based on New York, who loves clean, simple & unique design. I also enjoy crafting', 'finloans-companion' ),
            ]
        );
        $this->add_control(
            'about_yourself',
            [
                'label' => esc_html__( 'About Yourself', 'finloans-companion' ),
                'type' => Controls_Manager::TEXTAREA,
                'label_block' => true,
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Download CV', 'finloans-companion' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Personal Image Section', 'finloans-companion' ),
		...
		$this->add_control(
            'skills', [
                ...
                'fields' => [
                    [
                        'name' => 'item_title',
                        'label' => __( 'Skill Title', 'finloans-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default'     => __( 'Wireframing', 'finloans-companion' ),
                    ],
                    [
                        'name' => 'skill_val',
                        'label' => __( 'Skill Value', 'finloans-companion' ),
                        'label_block' => true,
                ...
                'default'   => [
                    [ 
                        'item_title'    => __( 'Weightlifting', 'finloans-companion' ),
                        'skill_val'   => __( '90', 'finloans-companion' ),
                    ],
                    [ 
                        'item_title'    => __( 'UI/UX', 'finloans-companion' ),
                        'skill_val'   => __( '70', 'finloans-companion' ),
                    ],
                    [ 
                        'item_title'    => __( 'Interaction design', 'finloans-companion' ),
                        'skill_val'   => __( '45', 'finloans-companion' ),
                    ],
                ]
            ]
		);
     ...
     */
        ...
        $this->start_controls_section(
            'style_features_section', [
                'label' => __( 'Style Features Section', 'finloans-companion' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'BG Styles', 'finloans-companion' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after'
            ]
        );
        $this->add_control(
            'sec_bg_color', [
                'label' => __( 'Bg Color', 'finloans-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
