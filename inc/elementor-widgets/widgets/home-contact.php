...
/**
 *
 * Finloans elementor home contact section widget.
 *
 * @since 1.0
 */
class Finloans_Home_Contact extends Widget_Base {

	public function get_name() {
		return 'finloans-home-contact';
	}

	public function get_title() {
		return __( 'Home Contact Section', 'finloans-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Tour function information without cross action media value quickly maximize timely deliverables.', 'finloans-companion' ),
            ]
        );
        $this->add_control(
            'form_shortcode',
            [
                ...
                'description' => esc_html__( 'Put your Contact form7 shortcode here.', 'finloans-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
            ]
        );
