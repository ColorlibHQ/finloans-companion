...
/**
 *
 * Finloans blogs Contents section widget.
 *
 * @since 1.0
 */
class Finloans_Blogs extends Widget_Base {

	public function get_name() {
		return 'finloans-blogs';
	}

	public function get_title() {
		return __( 'Blogs', 'finloans-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'blogs_content',
			[
				'label' => __( 'Blogs Contents', 'finloans-companion' ),
			]
        );
        $this->add_control(
            'big_text',
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Blog', 'finloans-companion' ),
            ]
        );
        $this->add_control(
            'sec_title',
            [
                'label' => esc_html__( 'Sec Title', 'finloans-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__( 'Our Creative Articles', 'finloans-companion' ),
            ]
        );
        $this->add_control(
            'btn_title',
            [
                'label'         => __( 'Button Title', 'finloans-companion' ),
                'type'          => Controls_Manager::TEXT,
                'label_block'   => true,
                'default'       => __( 'More Blogs', 'finloans-companion' )
            ]
        );
        $this->add_control(
            'btn_url',
            [
                'label'         => __( 'Button URL', 'finloans-companion' ),
        ...
        $this->add_control(
            'blogs_order',
            [
                'label'         => __( 'Blog Order', 'finloans-companion' ),
                'type'          => Controls_Manager::SWITCHER,
                'label_on' => __( 'DESC', 'finloans-companion' ),
				'label_off' => __( 'ASC', 'finloans-companion' ),
				'return_value' => 'yes',
				'default' => 'yes',
            ]
        );
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="creative_blog_active owl-carousel">
                        ...
                        <?php finloans_get_recent_blog_posts( $blogs_items, $blogs_order )?>
