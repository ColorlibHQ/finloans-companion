...
/**
 *
 * Finloans elementor apply loan section widget.
 *
 * @since 1.0
 */
class Finloans_Apply_Loan extends Widget_Base {

	public function get_name() {
		return 'finloans-apply-loan';
	}

	public function get_title() {
		return __( 'Apply for Loan', 'finloans-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'apply_loan_content',
			[
				'label' => __( 'Apply Loan content', 'finloans-companion' ),
			]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'descripion' => esc_html__( 'Best size is 1920x370', 'finloans-companion' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Apply for a Loan for your startup, education or company', 'finloans-companion' ),
            ]
        );
        $this->add_control(
            'btn_title',
            [
                ...
                'label_block' => true,'default'   => esc_html__( 'Apply Now', 'finloans-companion' ),
            ]
        );
        $this->add_control(
            'btn_url',
    ...
    <div class="apply_loan overlay" <?php echo finloans_inline_bg_img(esc_url($bg_img))?>>
        <div class="container">
