...
Tags: woocommerce, widgets, plugin, demo, companion, home page, one page, parallax, social, finloans, projects
...
Finloans Companion is a companion plugin for Companion WordPress theme by Colorlib.com.
== Description ==

Companion Companion is a companion for Companion One Page WordPress theme by Colorlib.com. This plugin won't do anything for other free or premium WordPress themes and you need to download and install <a href="https://colorlib.com/wp/themes/finloans/" target="_blank">Companion</a>. If you are having problems with Companion theme or its companion plugin the fastest way to receive help is via our theme <a href="https://colorlib.com/wp/forums" target="_blank">support forum</a>.
...
While Companion is a great one page WordPress theme it might not be for everyone therefore you might want to check other free <a href="https://colorlib.com/wp/themes/" target="_blank">WordPress themes</a> that are created by Colorlib.
...
1. Upload the whole contents of the folder `finloans-companion` to the `/wp-content/plugins/` directory
...
Currently it works only with Companion theme.

= Am I obligated to use it? =

You can still use Companion theme without this plugin but you won't be able to import demo content and use theme specific widgets that you see on front page of theme demo.
